...
A JavaScript SDK which provides commonly used utilties for interacting with Koil Protocol V2.
...
```js
import { KoilSDK, ConfigSdk, Network } from '@koil-finance/sdk';

const config: ConfigSdk = {
    network: Network.FUSE,
    rpcUrl: 'https://rpc.fuse.io',
};
const koil = new KoilSDK(config);
```

## SwapsService

The SwapsService provides function to query and make swaps using Koil V2 liquidity.
...
The Koil Vault provides a method to simulate a call to batchSwap.
