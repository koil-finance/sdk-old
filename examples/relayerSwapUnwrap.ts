...
import koilRelayerAbi from '../src/lib/abi/KoilRelayer.json';
...
async function runRelayerSwapUnwrapExactIn() {
    ...
    const txInfo = await koil.relayer.swapUnwrapAaveStaticExactIn(
        [
...
async function runRelayerSwapUnwrapExactOut() {
    ...
    const txInfo = await koil.relayer.swapUnwrapAaveStaticExactOut(
        [
            STABAL3PHANTOM.address,
            STABAL3PHANTOM.address,
            STABAL3PHANTOM.address,
